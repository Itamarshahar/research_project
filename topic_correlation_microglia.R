...
run_topic_evaluation <- function(fit_list, path_to_plots) {
  print("Loading libraries")
  load_libraries()
  helper_topic_evaluation(fit_list , path_to_plots, type = "genes") #, correlation_method = "kendall")
  helper_topic_evaluation(fit_list, path_to_plots, type = "cells") #, correlation_method = "kendall")
}
